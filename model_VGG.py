...
# ck+数据集
# path_train = 'face_images/ck+/Train'
# path_valid = 'face_images/ck+/Test'

# fer2013数据集
# path_train = 'face_images/FER2013/Training'
# path_valid = 'face_images/FER2013/PublicTest'
...
def RUN():
    ...
    for epoch in range(1, EPOCH + 1):
        ...
        if val_loss < best_val_loss:
            ...
            epochs_no_improve = 0
            # 可以在这里保存最佳模型
            torch.save(model, 'model/model_vgg_FE_epo_1000_lr_00001_batch_64_loss_1.pkl')
        else:
            epochs_no_improve += 1
...
def print_plot(train_plot, valid_plot, train_text, valid_text, ac, name):
    ...
    plt.title('vgg_result_FE_epo_1000_lr_00001_loss')
    plt.legend()
...
if __name__ == '__main__':
    ...
    toc = time.time()
    print("Time:", (toc - tic))
    plt.savefig('result_img/vgg_result_FE_epo_1000_lr_00001_loss.jpg')
