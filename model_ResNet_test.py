...
classification_model_path = 'model/model_resnet_fer2013.pkl'
...
#表情标签 对应ck+
# emotion_labels = {0: 'angry', 1: 'contempt', 2: 'disgust', 3: 'fear', 4: 'happy', 5: 'sad', 6: 'surprised'}
...
# 视频文件识别
video_capture = cv2.VideoCapture("video/newFaceTest.mp4")
...
# 输出GIF
# imageio.mimsave('result_img/res_test.gif', frames, 'GIF')
